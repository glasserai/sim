...
/**
 * The knowledge projector's periodic sweep: enqueues one pass per window and returns once
 * Trigger.dev accepts it. Writers ask for passes as they commit; this converges whatever those
 * requests missed.
 */
